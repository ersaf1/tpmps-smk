...
export const DEMO_USERS: Record<string, UserProfile> = {
  ...
  wks_kurikulum: {
    ...
    email: 'kurikulum@smk-unggul.sch.id',
    role: 'unit_kerja',
  ...
  wks_sarpras: {
    ...
    email: 'sarpras@smk-unggul.sch.id',
    role: 'unit_kerja',
    unitId: 'unit-sarpras',
  ...
  admin: {
    id: 'u-admin-01',
    name: 'Dimas Prasetyo (IT Admin)',
    email: 'admin.tpmps@smk-unggul.sch.id',
    role: 'admin',
...
export const UNIT_KERJA_LIST: UnitKerja[] = [
  ...
  },
  {
    ...
    picUserId: 'u-ks-01',
    pic: 'Haryanto, S.Pd.',
    email: 'kesiswaan@smk-unggul.sch.id',
    score: 87.2,
    totalIndicators: 15,
  ...
  },
  {
    ...
    email: 'perpus@smk-unggul.sch.id',
    score: 79.5,
    totalIndicators: 9,
  ...
  },
  {
    ...
    category: 'Layanan',
    picUserId: 'u-tpmps-02',
    pic: 'Kurniawan, S.T.',
    email: 'labkom@smk-unggul.sch.id',
    score: 85.0,
    totalIndicators: 11,
    completedIndicators: 10,
    status: 'Baik'
  },
  {
    ...
    email: 'kaprodi.pplg@smk-unggul.sch.id',
    score: 95.2,
    totalIndicators: 16,
  ...
  },
  {
    ...
    email: 'kaprodi.tjkt@smk-unggul.sch.id',
    score: 91.0,
    totalIndicators: 16,
  ...
  },
  {
    ...
    email: 'kaprodi.dkv@smk-unggul.sch.id',
    score: 88.5,
    totalIndicators: 15,
    completedIndicators: 14,
    status: 'Unggul'
  },
  {
    ...
    email: 'kaprodi.mplb@smk-unggul.sch.id',
    score: 87.0,
    totalIndicators: 14,
    completedIndicators: 13,
    status: 'Unggul'
  },
  {
    ...
    email: 'kaprodi.akl@smk-unggul.sch.id',
    score: 86.4,
    totalIndicators: 14,
    completedIndicators: 13,
    status: 'Unggul'
  },
  {
    ...
    email: 'kaprodi.tkr@smk-unggul.sch.id',
    score: 83.2,
    totalIndicators: 15,
  ...
  },
  {
    ...
    category: 'Layanan',
    picUserId: 'u-tpmps-01',
    pic: 'Dr. Surya Adi, M.Pd.',
    email: 'lsp@smk-unggul.sch.id',
    score: 93.0,
    totalIndicators: 10,
    completedIndicators: 10,
    status: 'Unggul'
  ...
  },
  {
    ...
    email: 'tpmps.sekretariat@smk-unggul.sch.id',
    score: 96.0,
    totalIndicators: 8,
    completedIndicators: 8,
    status: 'Unggul'
